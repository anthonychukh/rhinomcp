...
def test_new_commands():
    ...
    cases = [
        ...
        ("commands/gh_close_document.json", {"save_changes": "save", "save_path": "C:/Temp/example.gh", "overwrite": True}),
        ...
        ("commands/gh_bake_objects.json", {"instance_id": GUID, "output_index": 0, "layer": "Baked", "create_layer_if_missing": True}),
        ("commands/gh_get_script_source.json", {"instance_id": GUID}),
        ("commands/gh_set_script_source.json", {"nickname": "Python", "source": "a = x", "expected_language": "Python"}),
        ("commands/gh_trigger_button.json", {"alias": "run_button"}),
        ("commands/gh_set_toggle.json", {"instance_id": GUID, "value": True}),
...
def test_invalid_examples():
    ...
    invalid_examples = [
        ...
        ("commands/gh_close_document.json", {"save_changes": "prompt"}, "gh_close_document interactive policy"),
        ("commands/gh_close_document.json", {"save_changes": "discard", "save_path": "example.gh"}, "gh_close_document save_path without save"),
        ("commands/gh_bake_objects.json", {}, "gh_bake_objects missing selector"),
        ("commands/gh_get_script_source.json", {}, "gh_get_script_source missing selector"),
        ("commands/gh_set_script_source.json", {"nickname": "Python"}, "gh_set_script_source missing source"),
        ("commands/gh_trigger_button.json", {}, "gh_trigger_button missing selector"),
        ("commands/gh_set_toggle.json", {"value": True}, "gh_set_toggle missing selector"),
...
def test_protocol_envelope():
    ...
    expected_commands = [
        ...
        "gh_get_canvas_state", "gh_capture_preview", "gh_bake_objects",
        "gh_get_script_source", "gh_set_script_source", "gh_trigger_button", "gh_set_toggle",
        "gh_run_solution", "gh_expire_solution",
